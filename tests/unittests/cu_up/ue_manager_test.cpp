...
protected:
  void SetUp() override
  {
    ...
    // gtpu_m1_allocator = std::make_unique<dummy_gtpu_teid_pool>();
    gtpu_tx_notifier   = std::make_unique<dummy_gtpu_network_gateway_adapter>();
    f1u_gw             = std::make_unique<dummy_f1u_gateway>(f1u_bearer);
    // m1_gw              = std::make_unique<dummy_m1_gateway>(m1_bearer);
  ...
  // std::unique_ptr<gtpu_teid_pool>                             gtpu_m1_allocator;
  ...
  // dummy_inner_m1_bearer                                       m1_bearer;
  null_dlt_pcap                                               gtpu_pcap;
  std::unique_ptr<f1u_cu_up_gateway>                          f1u_gw;
  // std::unique_ptr<m1_cu_up_gateway>                           m1_gw;
