...
class f1u_bearer_impl final : public f1u_bearer, 
                              ...
                              public f1u_rx_pdu_mark_handler
{
public:
  f1u_bearer_impl(uint32_t                       ue_index_,
                  drb_id_t                       drb_id_,
  ...
  f1u_rx_pdu_mark_handler& get_rx_pdu_mark_handler() override { return *this; }

  void stop() override { dl_notif_timer.stop(); }

  void handle_pdu(nru_ul_message msg) override;
  void handle_pdu_to_mark(nru_ul_message msg) override;
...
private:
  ...
  f1u_rx_delivery_notifier_to_mark& rx_delivery_notifier_to_mark;
  ...
  void handle_pdu_to_mark_impl(nru_ul_message msg);
