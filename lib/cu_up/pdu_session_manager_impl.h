...
public:
  ...
  void update_ue_number (size_t ue_number);
...
private:
  ...
  // gtpu_teid_pool&                                          m1_teid_allocator;
  gtpu_demux_ctrl&                                         gtpu_rx_demux;
  // gtpu_demux_ctrl&                                         gtpu_m1_rx_demux;
  task_executor&                                           ue_dl_exec;
  task_executor&                                           ue_ul_exec;
  task_executor&                                           ue_ul_mark_exec;
  // task_executor&                                           ue_m1_ul_exec;
  task_executor&                                           ue_ctrl_exec;
  task_executor&                                           crypto_exec;
  dlt_pcap&                                                gtpu_pcap;
  f1u_cu_up_gateway&                                       f1u_gw;
  // m1_cu_up_gateway&                                        m1_gw;
