...
public:
  ue_context(ue_index_t                                  index_,
    ...
    pdu_session_manager(index,
                        ...
                        ue_exec_mapper->ul_pdu_mark_executor(),
                        // ue_exec_mapper->ul_m1_pdu_executor(),
  ...
  void update_ue_number (size_t ue_number) { return pdu_session_manager.update_ue_number(ue_number); }
