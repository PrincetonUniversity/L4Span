...
// /// \brief Adapter to connect M1 Rx SDU notifier to RLC Tx SDU handler.
// class m1_rx_rlc_sdu_adapter final : public m1_rx_sdu_notifier
// {
// public:
//   void connect(rlc_tx_m1_data_interface& rlc_tx_) { rlc_tx = &rlc_tx_; }
...
//   {
//     srsran_assert(rlc_tx != nullptr, "RLC Tx SDU notifier is disconnected");
//     rlc_tx->handle_m1_sdu(std::move(sdu));
//   }

// private:
//   rlc_tx_m1_data_interface* rlc_tx = nullptr;
// };

// F1-U Gateway
class m1_gateway_mru_rx_adapter final : public m1_du_gateway_bearer_rx_notifier
{
public:
  void connect(srs_du::m1_rx_pdu_handler& mru_rx_) { mru_rx = &mru_rx_; }
  ...
  {
    srsran_assert(mru_rx != nullptr, "MR-U RX PDU notifier is disconnected");
    mru_rx->handle_pdu(std::move(msg));
  }

private:
  srs_du::m1_rx_pdu_handler* mru_rx = nullptr;
};
...
// class rlc_tx_m1_sdu_adapter : public rlc_tx_m1_data_notifier
// {
// public:
//   void connect(m1_tx_sdu_handler& bearer_) { m1bearer = &bearer_; }

//   void disconnect();

//   void on_new_sdu(mru_ul_buffer_state ul_message) override
//   {
//     srsran_assert(m1bearer != nullptr, "RLC to M1 bearer notifier is disconnected");
//     m1bearer->handle_sdu(std::move(ul_message));
//   }

// private:
//   m1_tx_sdu_handler* m1bearer = nullptr;
// };
