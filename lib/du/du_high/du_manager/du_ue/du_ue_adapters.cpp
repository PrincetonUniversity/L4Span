...
// /// \brief M1 Bearer Sink. Used to discard events while in the process of destroying a UE bearer.
// class null_sink_m1_bearer :  public m1_bearer,
...
//   void handle_sdu(mru_ul_buffer_state sdu) override {}
//   void stop() override {}
// } null_m1_bearer;
...
class null_sink_rlc_m1_bearer : public rlc_tx_m1_data_interface
{
public:
  void handle_m1_sdu(byte_buffer sdu_buf) override {}
} null_rlc_m1_bearer;
...
// void m1_gateway_mru_rx_adapter::disconnect()
// {
//   connect(null_m1_bearer);
// }

// void m1_rx_rlc_sdu_adapter::disconnect()
// {
//   connect(null_rlc_m1_bearer);
// }
...
// void rlc_tx_m1_sdu_adapter::disconnect()
// {
//   connect(null_m1_bearer);
// }
