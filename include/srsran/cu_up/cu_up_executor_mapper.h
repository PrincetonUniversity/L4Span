...
public:
  ...
  /// \brief Returns the task executor to handle UL PDUs to MARK layer in the user plane.
  ///
  /// The returned executor should be of low priority, but optimized for high computational loads.
  virtual task_executor& ul_pdu_mark_executor() = 0;

  /// \brief Returns the task executor to handle UL PDUs in the user plane M1 interface.
  ///
  // /// The returned executor should be of low priority, but optimized for high computational loads.
  // virtual task_executor& ul_m1_pdu_executor() = 0;

  /// \brief Returns the task executor to handle DL PDUs in the user plane M1 interface.
  ///
  // /// The returned executor should be of low priority, but optimized for high computational loads.
  // virtual task_executor& dl_m1_pdu_executor() = 0;
...
public:
  ...
  // /// \brief Gets task executor that is used to write UL PDUs into the gateway.
  // virtual task_executor& io_ul_m1_executor() = 0;
