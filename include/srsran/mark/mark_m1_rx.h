...
/*
 * This file will hold the interfaces and notifiers for the MARK entity.
 * They follow the following nomenclature:
 *
 *   mark_{tx/rx}_{lower/upper}_{[control/data]}_{interface/notifier}
 *
...
class mark_rx_m1_interface
{
public:
  mark_rx_m1_interface()                                           = default;
  virtual ~mark_rx_m1_interface()                                  = default;
  mark_rx_m1_interface(const mark_rx_m1_interface&)             = delete;
  mark_rx_m1_interface& operator=(const mark_rx_m1_interface&)  = delete;
  mark_rx_m1_interface(const mark_rx_m1_interface&&)            = delete;
  mark_rx_m1_interface& operator=(const mark_rx_m1_interface&&) = delete;

  ///< Handle the incoming PDU.
  virtual void handle_feedback(byte_buffer pdu, drb_id_t drb_id_) = 0; 
};
...
class mark_rx_lower_interface
{
public:
  mark_rx_lower_interface()                                           = default;
  virtual ~mark_rx_lower_interface()                                  = default;
  mark_rx_lower_interface(const mark_rx_lower_interface&)             = delete;
  mark_rx_lower_interface& operator=(const mark_rx_lower_interface&)  = delete;
  mark_rx_lower_interface(const mark_rx_m1_interface&&)            = delete;
  mark_rx_lower_interface& operator=(const mark_rx_lower_interface&&) = delete;
