...
/// This interface notifies to MARK layer the reception of new SDUs in the receiving side of a SDAP entity.
class sdap_rx_sdu_notifier_mark
{
public:
  virtual ~sdap_rx_sdu_notifier_mark() = default;

  /// This callback is invoked on each generated SDU.
  virtual void on_new_sdu(byte_buffer sdu, qos_flow_id_t qfi, drb_id_t drb_id) = 0;
};
