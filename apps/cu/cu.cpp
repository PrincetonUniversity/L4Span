...
int main(int argc, char** argv)
{
  ...
  // // Create M1 (between RLC and MARK) GW
  // gtpu_demux_creation_request cu_m1_gtpu_msg   = {};
  // cu_m1_gtpu_msg.cfg.warn_on_drop              = true;
  // cu_m1_gtpu_msg.gtpu_pcap                     = cu_up_dlt_pcaps.m1.get();
  // std::unique_ptr<gtpu_demux> cu_m1_gtpu_demux = create_gtpu_demux(cu_m1_gtpu_msg);
  // udp_network_gateway_config  cu_m1_gw_config  = {};
  // cu_m1_gw_config.bind_address                 = cu_cfg.mru_cfg.bind_addr;
  // cu_m1_gw_config.bind_port                    = M1_GTPU_PORT;
  // cu_m1_gw_config.reuse_addr                   = false;
  // cu_m1_gw_config.pool_occupancy_threshold     = cu_cfg.mru_cfg.pool_occupancy_threshold;
  // // TODO: May need to change the ngu to something else
  // std::unique_ptr<srs_cu_up::ngu_gateway> cu_m1_gw =
  //     srs_cu_up::create_udp_ngu_gateway(cu_m1_gw_config, *epoll_broker, workers.cu_up_exec_mapper->io_ul_m1_executor());
  // std::unique_ptr<m1_cu_up_udp_gateway> cu_m1_conn =
  //     srs_cu_up::create_split_m1_gw({*cu_m1_gw, *cu_m1_gtpu_demux, *cu_up_dlt_pcaps.m1, M1_GTPU_PORT});
  ...
  // cu_up_unit_deps.m1_gateway       = cu_m1_conn.get();
