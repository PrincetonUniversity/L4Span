...
int main(int argc, char** argv)
{
  ...
  // // Create M1 connector
  // // TODO: Simplify this and use factory.
  // gtpu_demux_creation_request du_m1_gtpu_msg       = {};
  // du_m1_gtpu_msg.cfg.warn_on_drop                  = true;
  // du_m1_gtpu_msg.gtpu_pcap                         = du_pcaps.m1.get();
  // std::unique_ptr<gtpu_demux> du_m1_gtpu_demux     = create_gtpu_demux(du_m1_gtpu_msg);
  // udp_network_gateway_config  du_m1_gw_config      = {};
  // du_m1_gw_config.bind_address                     = du_cfg.mru_cfg.bind_address;
  // du_m1_gw_config.bind_port                        = M1_GTPU_PORT;
  // du_m1_gw_config.reuse_addr                       = false;
  // du_m1_gw_config.pool_occupancy_threshold         = du_cfg.mru_cfg.pool_threshold;
  // std::unique_ptr<srs_cu_up::ngu_gateway> du_m1_gw = srs_cu_up::create_udp_ngu_gateway(
  //     du_m1_gw_config,
  //     *epoll_broker,
  //     workers.get_du_high_executor_mapper(0).ue_mapper().m1_ul_pdu_executor(to_du_ue_index(0)));
  // std::unique_ptr<srs_du::m1_du_udp_gateway> du_m1_conn = srs_du::create_split_m1_gw(
  //     {du_m1_gw.get(), du_m1_gtpu_demux.get(), *du_pcaps.m1, M1_GTPU_PORT, du_cfg.mru_cfg.ext_addr});
  ...
  // du_dependencies.m1_gw              = du_m1_conn.get();
