                                                                ...
                                                                const cu_up_unit_dependencies& dependencies)
{
  ...
  // config.m1_gateway                     = dependencies.m1_gateway;
  ...
  // auto address_m1 = config.m1_gateway->get_cu_bind_address();
  // srsran_assert(address_m1.has_value(), "Invalid M1 bind address");

  config.net_cfg.f1u_bind_addr = address.value();
  // config.net_cfg.m1_bind_addr = address_m1.value();
  // Create NG-U gateway.
