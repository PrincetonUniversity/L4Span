...
static void configure_cli11_log_args(CLI::App& app, cu_up_unit_logger_config& log_params)
{
  ...
  app_services::add_log_option(app, log_params.mark_level, "--mark_level", "MARK log level");
  ...
  // app_services::add_log_option(app, log_params.m1_level, "--m1_level", "M1 log level");
...
static void configure_cli11_pcap_args(CLI::App& app, cu_up_unit_pcap_config& pcap_params)
{
  ...
  // add_option(app, "--m1_filename", pcap_params.m1.filename, "M1 GTP-U PCAP")->capture_default_str();
  // add_option(app, "--m1_enable", pcap_params.m1.enabled, "M1 GTP-U PCAP")->always_capture_default();
