...
static void fill_du_high_pcap_section(YAML::Node node, const du_high_unit_pcap_config& config)
{
  ...
  node["m1_filename"]   = config.m1.filename;
  node["m1_enable"]     = config.m1.enabled;
...
static void fill_du_high_log_section(YAML::Node node, const du_high_unit_logger_config& config)
{
  ...
  // node["m1_level"]          = srslog::basic_level_to_string(config.m1_level);
...
static YAML::Node build_du_high_pusch_section(const du_high_unit_pusch_config& config)
{
  ...
  node["b_offset_ack_idx_1"]       = config.b_offset_ack_idx_1;
  node["b_offset_ack_idx_2"]       = config.b_offset_ack_idx_2;
  node["b_offset_ack_idx_3"]       = config.b_offset_ack_idx_3;
  node["beta_offset_csi_p1_idx_1"] = config.b_offset_csi_p1_idx_1;
  node["beta_offset_csi_p1_idx_2"] = config.b_offset_csi_p1_idx_2;
  node["beta_offset_csi_p2_idx_1"] = config.b_offset_csi_p2_idx_1;
  node["beta_offset_csi_p2_idx_2"] = config.b_offset_csi_p2_idx_2;
